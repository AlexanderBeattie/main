...
public class CountryDetailsResponse {
  ...
  public String getPercentageTotalSummerWins() {
    return percentageTotalSummerWins != null ? Float.valueOf(percentageTotalSummerWins * 100)
                                                    .toString() : "-";
  }
  ...
  public String getPercentageTotalWinterWins() {
    return percentageTotalWinterWins != null ? Float.valueOf(percentageTotalWinterWins * 100)
                                                    .toString() : "-";
  }
